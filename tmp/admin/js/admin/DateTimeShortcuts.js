...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        // set in the deploy/base.html template, so if it's not there, someone's
        ...
        if (window.__admin_media_prefix__ != undefined) {
            ...
            DateTimeShortcuts.admin_media_prefix = '/missing-deploy-media-prefix/';
        }
    ...
    // Add a warning when the time zone in the browser and deploy do not match.
