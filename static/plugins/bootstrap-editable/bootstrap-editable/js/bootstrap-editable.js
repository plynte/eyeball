    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        ...
        Usefull to work with json response. For example, if your deploy response can be <code>{success: true}</code>
...
(function ($) {
    ...
    Popup.prototype = {
        ...
        init: function(element, options) {
            ...
            //attach document views to close containers on click / escape
        ...
        */       
        ...
        save: function(e, params) {
            /**        
            Fired when new value was submitted. You can use <code>$(this).data('editableContainer')</code> inside views to access to editableContainer instance
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //attach views activating editable. In disabled mode it just prevent default action (useful for links)
            if(this.options.toggle !== 'manual') {
                ...
                this.$element.on(this.options.toggle + '.editable', $.proxy(function(e){
                    ...
                    //stop propagation not required because in document click views it checks event target
                    //e.stopPropagation();
            ...
            $.when(doAutotext ? this.render() : true).then($.proxy(function() {
               ...
               Please note that you should setup `init` views **before** applying `editable`. 
    ...
    **/
    $.fn.editable = function (option) {
        ...
        switch (option) {
            ...
            **/
            ...
            @param {function} options.error(obj) error views 
            @param {function} options.success(obj,config) success views
    ...
    $.fn.editable.defaults = {
        ...
        **Note**: if you call <code>show</code> or <code>toggle</code> inside **click** views of some DOM element, 
...
(function ($) {
    ...
    AbstractInput.prototype = {
       ...
       **/
       ...
       /**
        attach views to automatically submit form when value changed (useful when buttons not shown)
       **/
       autosubmit: function() {
