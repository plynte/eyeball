...
(function($) {
	...
	// Check if the data field on the mock views and the request match. This 
	// can be used to restrict a mock views to being used only when a certain
	...
	// Check the given views should mock the given request
	function getMockForRequest( handler, requestSettings ) {
		...
		// Inspect the URL of the request and check if the mock views's url
		...
		var process = (function(that) {
			return function() {
				return (function() {
					...
					// the mock views a chance to update it's data
	...
	function processJsonpRequest( requestSettings, mockHandler, origSettings ) {
		...
		// If the response views on the moock is a function, call it
