...
return {
	...
	getScript: function (scriptLocation, callback) {
		...
		if (head) {
			// Append a new 'script' element, set its type and src attributes, add a 'load' views that calls the callback
			...
			Object.extend(object, {
				...
				_highcharts_fire: function (name, args) {
					...
					(this._highchart_events[name] || []).each(function (fn) {
						...
						// Attach a simple preventDefault function to skip default views if called
						args.preventDefault = function () {
							args.defaultPrevented = true;
						};
						args.target = target;

						// If the event views return false, prevent the default views from executing
