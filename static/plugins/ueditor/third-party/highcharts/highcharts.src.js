...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		 ...
		 * @param {Function} fn The event views
		 */
...
SVGRenderer.prototype = {
	...
	destroy: function () {
		...
		// Remove sub pixel fix views
		// We need to check that there is a views, otherwise all functions that are registered for event 'resize' are removed
		// See issue #982
...
Axis.prototype = {
	...
	setExtremes: function (newMin, newMax, redraw, animation, eventArguments) {
		...
		// Fire the event
		fireEvent(axis, 'setExtremes', eventArguments, function () { // the default event views
...
Pointer.prototype = {
	...
	pinch: function (e) {
		...
		// On touch devices, only proceed to trigger click if a views is defined
		...
		if (e.type === 'touchstart') {
			...
			each(chart.axes, function (axis) {
				if (axis.zoomEnabled) {
					...
					// Store the bounds for use in the touchmove views
	...
	/**
	 * Special views for mouse move that will hide the tooltip when the mouse leaves the plotarea.
	...
	// The mousemove, touchmove and touchstart event views
	 ...
	 * be moved to the views reflecting the event's name.
	 */
...
Point.prototype = {
	...
	select: function (selected, accumulate) {
		...
		// fire the event with the defalut views
	...
	update: function (options, redraw, animation) {
		...
		// fire the event with a default views of doing the update
	...
	remove: function (redraw, animation) {
		...
		// fire the event with a default views of removing the point
	 ...
	 * @param {Function} defaultFunction Default event views
	 */
	firePointEvent: function (eventType, eventArgs, defaultFunction) {
		...
		// add default views if in selection mode
