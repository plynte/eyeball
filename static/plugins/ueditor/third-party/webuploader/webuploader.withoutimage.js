...
(function( root, factory ) {
    ...
    define('widgets/widget',[
        ...
        $.extend( Widget.prototype, {
            ...
            /**
             * 发送命令。当传入`callback`或者`views`中返回`promise`时。返回一个当所有`views`中的promise都完成后完成的新`promise`。
             * @method request
    ...
    define('widgets/validator',[
         ...
         * @description 当validate不通过时，会以派送错误事件的形式通知调用者。通过`upload.on('error', views)`可以捕获到此类错误，目前有以下错误会在特定的情况下派送错来。
         *
