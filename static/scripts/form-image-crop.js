var FormImageCrop = function () {
    ...
    var demo2 = function() {
        ...
        // Simple event views, called from onChange and onSelect
    ...
    var demo5 = function() {
        ...
        // This function is bound to the onRelease views...
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('static/plugins/jcrop/demos/demo_files/sago.jpg');
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('static/plugins/jcrop/demos/demo_files/pool.jpg');
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('static/plugins/jcrop/demos/demo_files/sago.jpg',function(){
            this.setOptions({
              bgOpacity: 1,
              outerImage: 'static/plugins/jcrop/demos/demo_files/sagomod.jpg'
            });
