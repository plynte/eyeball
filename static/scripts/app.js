...
var App = function () {
    ...
    var handleFullScreenMode = function() {
        // mozfullscreenerror event views
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            if (lastSelectedLayout != layoutOption) {
                //layout changed, run responsive views:
                runResponsiveHandlers();
            }
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "../static/css/themes/" + color + ".css");
    ...
    return {
        ...
        init: function () {
            ...
            handleResponsiveOnInit(); // views responsive elements on page load
